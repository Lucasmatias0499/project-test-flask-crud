...
class UserRoutesTestCase(unittest.TestCase):
    ...
    @patch('app.models.User')
    def test_update_user_success(self, MockUser, mock_update):
        MockUser.validate_name.return_value = None
        user_mock = MagicMock()
        user_mock.to_dict.return_value = {'id': 1, 'name': 'Lucas'}
        mock_update.return_value = user_mock
    ...
    @patch.object(user_repo, 'update')
    @patch('app.models.User')
    def test_update_user_not_found(self, MockUser, mock_update):
        MockUser.validate_name.return_value = None
    ...
    @patch.object(user_repo, 'update')
    @patch('app.models.User')
    def test_update_user_internal_error(self, MockUser, mock_update):
        MockUser.validate_name.return_value = None
